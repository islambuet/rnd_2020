...
<div class="card mt-2">
    ...
    <div class="card-body">
        <form id="save_form" class="system_ajax" action="<?php echo site_url($CI->controller_name.'/system_save_add_edit');?>" method="post">
            ...
            <div class="row mb-2">
                <div class="col-4">
                    <label for="status_replica" class="font-weight-bold float-right"><?php echo $CI->lang->line('LABEL_STATUS_REPLICA');?><span class="text-danger">*</span></label>
                </div>
                <div class="col-lg-4 col-8">
                    <select id="status_replica" name="item[status_replica]" class="form-control">
                        <option value="<?php echo SYSTEM_STATUS_NO; ?>"<?php if($item['status_replica']==SYSTEM_STATUS_NO){echo ' selected';}?> ><?php echo SYSTEM_STATUS_NO; ?></option>
                        <option value="<?php echo SYSTEM_STATUS_YES; ?>"<?php if($item['status_replica']==SYSTEM_STATUS_YES){echo ' selected';}?> ><?php echo SYSTEM_STATUS_YES; ?></option>
                    </select>
                </div>
            </div>
            <div class="row mb-2">
