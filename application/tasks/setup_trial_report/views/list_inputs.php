...
if(isset($CI->permissions['action2']) && ($CI->permissions['action2']==1))
{
    $action_buttons[]=array(
        ...
        'data-action-link'=>site_url($CI->controller_name.'/system_edit_input/'.$item['id'])
    );
}
...
$action_buttons[]=array(
    ...
    'class'=>'system_ajax',
    'href'=>site_url($CI->controller_name.'/system_list_input/'.$item['id'])
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_name.'/system_get_items_list_input/'.$item['id']); ?>";
        // prepare the data
        var source =
        {
            dataType: "json",
