            ...
            <div class="row mb-2">
                ...
                <div class="col-lg-4 col-8">
                    <select id="status" name="status" class="form-control">
                        ...
                        <option value="<?php echo SYSTEM_STATUS_APPROVED; ?>"><?php echo SYSTEM_STATUS_APPROVED; ?></option>
                        <option value="<?php echo SYSTEM_STATUS_REJECTED; ?>"><?php echo SYSTEM_STATUS_REJECTED; ?></option>
                    </select>
                </div>
            </div>
            <div id="container_reject" class="d-none">
                <div class="row mb-2">
                    <div class="col-4">
                        <label for="remarks_reject" class="font-weight-bold float-right"><?php echo $CI->lang->line('LABEL_REMARKS_REJECT');?><span class="text-danger">*</span></label>
                    </div>
                    <div class="col-lg-4 col-8">
                        <textarea id="remarks_reject" class="form-control" name="remarks_reject"></textarea>
                    </div>
                </div>
            </div>
            <div id="container_approve">
                <div class="row mb-2">
                    <div class="col-4">
...
<script type="text/javascript">
    jQuery(document).ready(function()
    {
        ...
        {
            if($(this).val()=='<?php echo SYSTEM_STATUS_REJECTED; ?>')
            {
                $('#container_approve').addClass('d-none');
                $('#container_reject').removeClass('d-none');
            }
            else
            {
                $('#container_approve').removeClass('d-none');
                $('#container_reject').addClass('d-none');
            }
        });
