...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        var url = "<?php echo site_url($CI->controller_name.'/system_get_items_list/'.$trial_id.'/'.$year.'/'.$season_id); ?>";
        // prepare the data
        var source =
        {
            dataType: "json",
        ...
        $(document).on("change","#year",function()
        {
            ...
            $.ajax({
                url: '<?php echo site_url($CI->controller_name.'/system_list/'.$trial_id); ?>',
                type: 'POST',
                datatype: "JSON",
                data:{year:year,season_id:season_id},
